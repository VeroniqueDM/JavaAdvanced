...
//
//    public boolean removeCloth(String color) {
//        Cloth cloth = this.data.stream().filter(c -> c.getColor().equals(color)).findFirst().orElse(null);
//        if (cloth != null) {
//            return this.data.remove(cloth);
//        }
//        return false;
...
//                .collect(Collectors.toList())
//                .get(0);
////        return this.data.stream().sorted(Comparator.comparing(Cloth::getSize)).findFirst().orElse(null);
//    }
//
//    public Cloth getCloth(String color) {
